 ...
 * @property {string} [overrideESLintClient] - Force the use of a specific eslint api. Valid options:
 * - An absolute path
 * - 'global'
 * - 'bundled'.
 ...
 * @property {boolean} [allowBundled=false] - Allow using the eslint version that comes with pulsar-eslint.
 */
 ...
 * @property {boolean} [allowNvmLoader=false]
